import {
  Building, Users, Tag, LayoutGrid, BookOpen,
  FolderOpen, Utensils, Settings, Bell, Eye,
  Sparkles, Calendar, ShoppingBag, UsersRound,
} from 'lucide-react';
...
export const onboardingLevels: OnboardingLevel[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Crie tags reutilizáveis (ex: Vegano, Sem Glúten, Picante)',
        icon: Tag,
        status: 'optional',
        route: '/tags',
        action: 'Criar Tags',
    ...
    steps: [
      {
        id: 'menu',
        title: 'Menu/Cardápio',
        description: 'Crie cardápios com horários específicos (Almoço, Jantar, Happy Hour)',
        icon: BookOpen,
        status: 'recommended',
        route: '/admin-menu',
        action: 'Criar Menu',
      ...
      },
      {
        id: 'categories',
        title: 'Categorias',
        description: 'Adicione categorias ao menu (Entradas, Pratos Principais, Sobremesas)',
        icon: FolderOpen,
        status: 'recommended',
        route: '/admin-menu',
    ...
    steps: [
      {
        ...
        description: 'Configure envio automático de SMS, WhatsApp e Email',
        icon: Bell,
        status: 'optional',
        route: '/settings',
        action: 'Configurar',
      ...
      },
      {
        ...
        description: 'Personalize quais informações aparecem no cardápio público',
        icon: Eye,
        status: 'optional',
        route: '/settings',
        action: 'Personalizar',
