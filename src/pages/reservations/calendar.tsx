...
export default function ReservationCalendar() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case "confirmed": return "bg-success/10 text-success"; // Confirmada
      case "cancelled": return "bg-destructive/10 text-destructive"; // Cancelada
      case "completed": return "bg-primary/10 text-primary"; // Completa
      case "no_show": return "bg-warning/10 text-warning"; // Não compareceu
